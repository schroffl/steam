...
const Market = {
	 ...
	 * @param      {Object}   obj     Multiple objects that will be merged into
	 *                                one.
	 * @param      {SteamUser}  obj.user   Instance of SteamUser
	 * @param      {Number}     obj.appid  The steam-appid of the application
	 * @param      {String}     obj.name   The name of the item on the market
	 ...
	 * @param      {Number}         obj.quantity   The amount of items to buy (Defaults
	 *                                             to 1)
	 ...
	 * @param      {Number}     obj.price     The amount of money the seller will
	 *                                        receive (without fee)
	 * @param      {Number}     obj.quantity  The amount of items to sell (Defaults to
	 *                                        1)
